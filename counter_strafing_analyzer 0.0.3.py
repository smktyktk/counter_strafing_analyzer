...
def analyze_statistics(text_area):
    ...
    diff_with_123ms_key = avg_hold_time - 0.123
    ...
    text_area.insert(tk.END, f"Difference with 123ms: {diff_with_123ms_key:.3f} seconds\n")
    if diff_with_123ms_key > 0.043:
        text_area.insert(tk.END, "Holding too long!\n\n")
    elif diff_with_123ms_key < -0.043:
        text_area.insert(tk.END, "Holding too short!\n\n")
    else:
        text_area.insert(tk.END, "Timing just right!\n\n")
    ...
    if diff_with_80ms_mouse < 0:
        text_area.insert(tk.END, "Mouse click too early!\n\n")
    elif diff_with_80ms_mouse > 0:
        text_area.insert(tk.END, "Mouse click timing is good!\n\n")
